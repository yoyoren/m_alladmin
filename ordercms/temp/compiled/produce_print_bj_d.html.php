...
<div class="ztdiv">
	...
	<div class="container1">
		<div style="width:297px;margin-left:27px;">
			<p style='margin:0;padding:0;margin-left:2px;' class="content_14"><b><font size="-4">品名:<?php echo $this->_var['order']['gname']; ?></font><b style='margin-left:80px;'><font size="-1"><?php echo $this->_var['print_sn']; ?>&nbsp;&nbsp;<?php echo $this->_var['pack']['route_name']; ?>-<?php echo $this->_var['pack']['turn']; ?>-<?php if ($this->_var['order']['ice_bag_num'] < 10): ?>0<?php endif; ?><?php echo $this->_var['order']['ice_bag_num']; ?></font></b></p>
			<div style='margin-left:2px;'>
			<b class="content_text"><font size="-4">配料：<?php echo $this->_var['order']['goods_pl']; ?></font></b><br/>
			致敏信息提示：本产品配料中含乳制品、小麦制品、蛋制品、杏仁制品等。
			</div>
			<table cellspacing='0' cellpadding='0'style='margin:0;padding:0;' border='0' width="308">
				...
				<tr>
					<td style="vertical-align:top;width:134px;">
						...
						本品仅在MES每实官网售卖<br/>
						<?php if ($this->_var['order']['weight'] == "454g"): ?>
