...
<table width="700" border="0" height="">
	<tr height="30">
	  ...
	  <?php $_from = $this->_var['array']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'pack_0_66432600_1386839988');if (count($_from)):
    foreach ($_from AS $this->_var['pack_0_66432600_1386839988']):
?>
	  <font size="-1"><?php echo $this->_var['pack_0_66432600_1386839988']; ?></font><br/>
...
<table width="700" height="136" border="0">
    ...
    <?php $_from = $this->_var['goods']['goods']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods_0_66517300_1386839988');if (count($_from)):
    foreach ($_from AS $this->_var['goods_0_66517300_1386839988']):
?>
     <tr height="16" style="line-height:12px;">
          <td width="11%" align="left"><?php echo $this->_var['goods_0_66517300_1386839988']['goods_name']; ?></td>
          <td width="9%" align="center"><?php echo $this->_var['goods_0_66517300_1386839988']['goods_attr']; ?></td>
           <td width="8%" align="center"><?php echo $this->_var['goods_0_66517300_1386839988']['goods_number']; ?></td>
           <td width="8%" align="center"><?php if ($this->_var['goods_0_66517300_1386839988']['goods_sn'] == 'D3'): ?>套<?php else: ?>个<?php endif; ?></td>
           <td width="13%" align="center"><?php echo $this->_var['goods_0_66517300_1386839988']['goods_price']; ?></td>
           <td width="10%" align="center"><?php echo $this->_var['goods_0_66517300_1386839988']['goods_discount']; ?></td>
           <td width="41%"><?php echo $this->_var['goods_0_66517300_1386839988']['goods_sub']; ?></td>
     </tr>
    <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
