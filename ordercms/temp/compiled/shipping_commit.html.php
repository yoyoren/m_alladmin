...
?>
	...
	<tr bgcolor="#ffffff">	
		<td colspan="2">总计</td>
		<td align="right"><?php if ($this->_var['total']['turn1_025_t']): ?><?php echo $this->_var['total']['turn1_025_t']; ?><?php else: ?>&nbsp;<?php endif; ?></td>
		<td align="right"><?php if ($this->_var['total']['turn1_1_t']): ?><?php echo $this->_var['total']['turn1_1_t']; ?><?php else: ?>&nbsp;<?php endif; ?></td>
		<td align="right"><?php if ($this->_var['total']['turn1_15_t']): ?><?php echo $this->_var['total']['turn1_15_t']; ?><?php else: ?>&nbsp;<?php endif; ?></td>
		<td align="right"><?php if ($this->_var['total']['turn1_2_t']): ?><?php echo $this->_var['total']['turn1_2_t']; ?><?php else: ?>&nbsp;<?php endif; ?></td>
		<td align="right"><?php if ($this->_var['total']['turn1_3_t']): ?><?php echo $this->_var['total']['turn1_3_t']; ?><?php else: ?>&nbsp;<?php endif; ?></td>
		<td align="right"><?php if ($this->_var['total']['turn1_5_t']): ?><?php echo $this->_var['total']['turn1_5_t']; ?><?php else: ?>&nbsp;<?php endif; ?></td>
		<td align="right"><?php if ($this->_var['total']['turn1_orderstotal']): ?><?php echo $this->_var['total']['turn1_orderstotal']; ?><?php else: ?>&nbsp;<?php endif; ?></td>
		<td align="right"><?php if ($this->_var['total']['turn1_goodstotal']): ?><?php echo $this->_var['total']['turn1_goodstotal']; ?><?php else: ?>&nbsp;<?php endif; ?></td>
		<td align="right"><?php if ($this->_var['total']['total_p']): ?><?php echo $this->_var['total']['total_p']; ?><?php else: ?>&nbsp;<?php endif; ?></td>
		<td align="right"><?php if ($this->_var['total']['shipping_fee']): ?><?php echo $this->_var['total']['shipping_fee']; ?><?php else: ?>&nbsp;<?php endif; ?></td>
	</tr>
</table>
<?php if ($this->_var['full_page']): ?>
</div>
