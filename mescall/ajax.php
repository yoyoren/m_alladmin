...
elseif($_GET['act']=='check_bonus')
{
	...
	else
	{
		...
		$sql = "SELECT bonus_sn,bonus_type_id,type_money,bonus_id,order_id,use_start_date,use_end_date,bonus_money,sdate,edate,flag FROM ecs_user_bonus,ecs_bonus_type ";
